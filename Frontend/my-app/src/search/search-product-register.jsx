...
const SearchProductRegister = ({products, children}) => {
    ...
    const handleChange = (event) => {
        setCurrentProduct(products.filter(product => {
            return product.product_id === event.target.value;
        }).pop())
    }
    ...
    return(
        <div>
            {(!currentProduct)? (
                <DisabledChart
                    disabledMessage={messageDict['jackpot-personal']['no-products'][language]}
                >
                ...
                <div>
                    ...
                    <form>
                        <div>
                            <label
                                id="product">{interactiveDict['product-form']['product-field'][language]}
                            </label>
